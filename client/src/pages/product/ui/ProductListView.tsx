                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50">
                            <tr className="text-xs text-gray-500">
                                ...
                                <th
                                    className="hidden cursor-pointer px-3 py-3 text-right hover:text-gray-700 md:table-cell"
                            ...
                            {filtered.map((product) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="hidden px-3 py-3 text-right text-gray-700 md:table-cell">
                                            <span
                                                className={
                                        ...
                                        <td className="px-3 py-3 text-center">
                                            <span
                                                className={`rounded-full px-2 py-1 text-xs font-medium ${product.active ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}
                                            >
