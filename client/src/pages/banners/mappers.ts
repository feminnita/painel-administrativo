...
export function mapApiSlide(s: Record<string, any>): Slide {
  return {
    ...
    text_position_mobile: s.textPositionMobile ?? "",
    text_theme_mobile: s.textThemeMobile ?? "",
...
export function toApiSlide(input: SlideInput) {
  return {
    ...
    textPositionMobile: input.text_position_mobile || null,
    textThemeMobile: input.text_theme_mobile || null,
    focal: input.focal,
...
export function buildSlidePayload(input: SlideInput): SlideInput {
  return {
    ...
    text_position_mobile: input.text_position_mobile || "",
    text_theme_mobile: input.text_theme_mobile || "",
